...
<?php
 ...
 if($totalItens > 0){
   ...
   if($pg_after != 0):
       ...
       <a class="page-link" href="userSocio.php?pgCli='.$pg_after.'" tabindex="-1" aria-disabled="true">Previous</a>
       </li>';
   else:
   ...
   for($i = 1; $i < $numeroPgs + 1; $i++):
       echo'<li class="page-item"><a class="page-link" href="userSocio.php?pgCli='.$i.'">'. $i .'</a></li>';
   endfor;
   //fim
   ...
   if($pg_before <= $numeroPgs):
       echo'<li class="page-item">
       <a class="page-link" href="userSocio.php?pgCli='.$pg_before.'">Next</a>
       </li>';
   else:
       echo'<li class="page-item disabled">
